...
See SRS Documentation at \url{https://github.com/zheniasigayev/MES-Finance-Tracking/blob/main/docs/SRS/SRS.pdf}.
...
\begin{itemize}
  \item Hardware Hiding Module (M1) for OCR services, queueing, and storage while processing.
