...
\begin{tabularx}{\textwidth}{p{3cm}p{2cm}X}
  \toprule {\bf Date} & {\bf Version} & {\bf Notes}\\
    \midrule
      ...
      Apr 5 & 1.1 & Updated document to align with latest project requirements\\
       ... & ... & ...\\
  \bottomrule
\end{tabularx}
...
\section{System Overview}
  ...
  \subsection{Technology Stack Overview}
    ...
    \begin{itemize}
        ...
        \item Google Geimini LLM Pipeline integrated via API to handle receipt parsing and data extraction.
    \end{itemize}
    ...
    \begin{itemize}
        ...
        \item Google Cloud Platform for AI infrastructure and cloud storage of receipt images. 
    \end{itemize}
...
\section{Stakeholders}
  \subsection{Direct Stakeholders}
    \subsubsection{Club Leadership (President and VPs)}
      \begin{itemize}
        \item \textbf{Description}: Members of the executive team of clubs that fall under the MES.  
        \item \textbf{Use Cases:}
          \begin{itemize}
            \item Provide final approval before sending reimbursement requests to MES using club executive dashboard.
          ...
          \end{itemize}
      \end{itemize}
    \subsubsection{General Club Members}
      \begin{itemize}
        \item \textbf{Description}: Any member of clubs that fall under the MES.
        \item \textbf{Use Cases:}
          \begin{itemize}
            \item Submit expense reimbursement requests for expenses incurred on behalf of their club, pending review of executives, using only a picture.
          \end{itemize}
      \end{itemize}
    \subsubsection{MES Finance Administrators}
      \begin{itemize}
        ...
        \item \textbf{Use Cases:}
          \begin{itemize}
            \item Approve or reject requests quickly via MES Admin Dashboard.
...
\section{Terminology, Acronyms, and Technologies}
  ...
  \subsection{Terminology}
    \begin{itemize}
      ...
      \item \textbf{Role Based Access Control (RBAC)}: System to ensure only authorized users see sensitive reimbursement information and can perform certain actions based on their role (e.g., submitter, reviewer, administrator).
...
\section{The Scope of the Work}
  \subsection{The Current Situation}
    The MES currently uses spreadsheets and manual processes to track club finances, this is a very tedious process that is time-consuming and error-prone. 
    This approach results in a large amount of work for MES financial staff due to lost receipts, duplicated claims, or other manual errors. A centralized
...
\section{Functional Requirements}
  \subsection{Functional Requirements [FRQ]}
    \begin{enumerate}
      ...
      \item The system shall automatically extract transaction details from uploaded images using LLM-pipelines
      \item The system shall provide centralized club dashboard for leadership to track and approve member submissions
    \end{enumerate}
...
\begin{enumerate}
    ...
    \item All updates to reimbursements must be tracked, including specific user performing the action.
\end{enumerate}
...
\section{Ideas for Solution}
  \begin{itemize}
    ...
    \item Integrate Google Gemini for automated data extraction to satisfy the 'only picture is needed' submission requirement.
    ...
    \item Leverage free technology for long-term project sustainability. 
  \end{itemize}
