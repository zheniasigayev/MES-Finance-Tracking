...
We propose using the MIT License unless MES prefers a different arrangement.
...
- Synchronous chat (Discord) for quick coordination; email for formal stakeholder communications.
