...
There are multiple main risks regarding the success of our project. We have proposed
a few minimal Proof of Concept (PoC) functionalities that, if not completed, may render the rest of the 
project useless thus and must be first addressed in our Proof of Concept:
\begin {enumerate}
  \item \textbf{Local MVP WebApp}
