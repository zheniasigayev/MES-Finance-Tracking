...
\midrule
FRQ-1 & FRQ-1-SUBMIT & UI automation + DB check & Reimbursement requests were submitted successfully via Receipt Image Upload with AI extraction accurately identifying sub-totals and HST & Pass\\
FRQ-2 & FRQ-2-REVIEW & UI workflow + backend verification & Reviewers successfully approved/rejected requests via MES Admin Dashboard & Pass\\
...
review activities from \texttt{NFL-MNT-1}. The use of freemium technology ensures
long-term sustainability and low overhead for MES Infra-Tech team maintenance.
